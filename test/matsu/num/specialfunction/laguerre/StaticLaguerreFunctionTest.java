...
/**
 * {@link StaticLaguerreFunction} クラスのテスト.
 * 
 * @author Matsuura Y.
 */
@RunWith(Enclosed.class)
final class StaticLaguerreFunctionTest {
    ...
    public static class 次数5_階数2のテスト {
        ...
        private final StaticLaguerreFunction function = new StaticLaguerreFunction();
        ...
        public void test(LaguerreLFixture fixture) {
            ...
            double result = function.laguerreL(5, 2, x);
    ...
    public static class 次数20_階数10のテスト {
        ...
        public void test(LaguerreLFixture fixture) {
            ...
            double result = function.laguerreL(20, 10, x);
    ...
    public static class 特殊値に関するテスト {
        ...
        public void test_n_100_k_100_x_100000() {
            assertThat(
                    new StaticLaguerreFunction().laguerreL(100, 100, 100000d),
        ...
        public void test_n_100_k_97_x_100000() {
            assertThat(
                    new StaticLaguerreFunction().laguerreL(100, 97, 100000d),
                    is(Double.POSITIVE_INFINITY));
        }
        ...
        public void test_n_97_k_100_x_100000() {
            assertThat(
                    new StaticLaguerreFunction().laguerreL(97, 100, 100000d),
        ...
        public void test_n_97_k_97_x_100000() {
            assertThat(
                    new StaticLaguerreFunction().laguerreL(97, 97, 100000d),
                    is(Double.NEGATIVE_INFINITY));
        }
    }
