...
/**
 * {@link Bessel0thOrderOptimizedLegacy}クラスのテスト.
 *
 * @author Matsuura Y.
 */
@RunWith(Enclosed.class)
final class Bessel0thOrderOptimizedLegacyTest {

    public static final Class<?> TEST_CLASS = Bessel0thOrderOptimizedLegacy.class;

    private static final DoubleRelativeAssertion DOUBLE_RELATIVE_ASSERTION =
            new DoubleRelativeAssertion(1E-12);

    private static final Bessel0thOrderOptimizedLegacy BESSEL_0 = new Bessel0thOrderOptimizedLegacy();
