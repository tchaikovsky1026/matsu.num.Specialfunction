...
/**
 * {@link Bessel1stOrderLegacyOptimized}クラスのテスト.
 *
 * @author Matsuura Y.
 */
@RunWith(Enclosed.class)
final class Bessel1stOrderLegacyOptimizedTest {

    public static final Class<?> TEST_CLASS = Bessel1stOrderLegacyOptimized.class;

    private static final DoubleRelativeAssertion DOUBLE_RELATIVE_ASSERTION =
            new DoubleRelativeAssertion(1E-12);

    private static final Bessel1stOrderLegacyOptimized BESSEL_1 = new Bessel1stOrderLegacyOptimized();
