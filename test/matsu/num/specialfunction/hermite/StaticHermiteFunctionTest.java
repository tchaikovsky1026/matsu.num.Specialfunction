...
/**
 * {@link StaticHermiteFunction} クラスのテスト.
 */
final class StaticHermiteFunctionTest {

    public static final Class<?> TEST_CLASS = StaticHermiteFunction.class;
    ...
    public static class 次数5のテスト {
        ...
        private final StaticHermiteFunction function = new StaticHermiteFunction();
        ...
        public void test(HermiteHFixture fixture) {
            ...
            double result = function.hermiteH(5, x);
    ...
    public static class 次数20のテスト {
        ...
        public void test(HermiteHFixture fixture) {
            ...
            double result = function.hermiteH(20, x);
    ...
    public static class 特殊値に関するテスト {
        ...
        public void test_n_100_x_1000() {
            assertThat(
                    new StaticHermiteFunction().hermiteH(100, 1000d),
        ...
        public void test_n_75_x_10000() {
            assertThat(
                    new StaticHermiteFunction().hermiteH(75, 10000d),
                    is(Double.POSITIVE_INFINITY));
        }
    }
