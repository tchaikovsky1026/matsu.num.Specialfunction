...
/**
 * {@link MinimaxApproxFunc_Digamma2p} のminimax近似.
 * 
 * @author Matsuura Y.
 */
public final class CoeffiCalc_Digamma2p {
    ...
    private static final class EachIntervalExecutor {
        ...
        void execute(DoubleFiniteClosedInterval interval) {
            ...
            MinimaxApproxFunc_Digamma2p target =
                    new MinimaxApproxFunc_Digamma2p(interval);
