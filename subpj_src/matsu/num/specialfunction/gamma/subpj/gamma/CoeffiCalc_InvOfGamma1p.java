...
/**
 * {@link MinimaxApproxFunc_InvOfGamma1p} のminimax近似.
 * 
 * @author Matsuura Y.
 */
public final class CoeffiCalc_InvOfGamma1p {
    ...
    public static void main(String[] args) {
        ...
        executor.execute(DoubleFiniteClosedInterval.from(-0.5, 0.5));
    ...
    private static final class EachIntervalExecutor {
        ...
        void execute(DoubleFiniteClosedInterval interval) {
            ...
            MinimaxApproxFunc_InvOfGamma1p target = new MinimaxApproxFunc_InvOfGamma1p(interval);
