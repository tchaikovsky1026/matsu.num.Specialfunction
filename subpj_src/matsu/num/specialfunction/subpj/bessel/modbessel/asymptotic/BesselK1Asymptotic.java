 ...
 * @author Matsuura Y.
 */
final class BesselK1Asymptotic extends RawCoeffCalculableFunction<DoubleDoubleFloatElement> {
    ...
    private static void executeEach(int order, double t1, double t2) {
        new EachApproxExecutor(order).execute(new BesselK1Asymptotic(t1, t2));
    }

    private BesselK1Asymptotic(double t1, double t2) {
        super();
