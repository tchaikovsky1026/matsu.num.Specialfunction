 ...
 * @author Matsuura Y.
 */
final class BesselK1Asymptotic_accurate extends RawCoeffCalculableFunction<DoubleDoubleFloatElement> {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("t = 1/(8x), K1(x) = sqrt(pi/(2x)) * exp(-x) * F(t) としたときの");
        System.out.println("F(t)の推定");
        System.out.println();

        new EachApproxExecutor(11).execute(new BesselK1Asymptotic_accurate(T_MIN, T_MAX));

        System.out.println("finished...");
    }

    private BesselK1Asymptotic_accurate(double t1, double t2) {
        super();
