...
/**
 * {@link MinimaxApproxFunc_LGamma2p} のminimax近似.
 * 
 * @author Matsuura Y.
 */
public final class CoeffiCalc_LGamma2p {
    ...
    private static final class EachIntervalExecutor {
        ...
        void execute(DoubleFiniteClosedInterval interval) {
            ...
            MinimaxApproxFunc_LGamma2p target = new MinimaxApproxFunc_LGamma2p(interval);
