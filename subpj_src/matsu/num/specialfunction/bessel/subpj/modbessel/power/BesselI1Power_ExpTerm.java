 ...
 * 
 * <p>
 * I0はexpの発散が強くなるので, I1(x)*exp(-x)に対して近似を行う.
 * スケールは1である.
 * </p>
 * 
 * <p>
 ...
 * @author Matsuura Y.
 */
final class BesselI1Power_ExpTerm implements RawCoefficientCalculableFunction {
     ...
     * @param minX minX
     */
    public BesselI1Power_ExpTerm(DoubleFiniteClosedInterval interval, double minX) {
        super();
