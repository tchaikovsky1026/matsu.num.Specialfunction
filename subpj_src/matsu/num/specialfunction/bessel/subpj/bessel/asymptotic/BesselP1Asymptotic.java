 ...
 * 
 * <p>
 * P1はtの0次, 2次, ... しかないが, 奇数次も含むとして推定する.
 * </p>
 * 
 * <p>
 * P1(t)の第3次近似をp(u)とする. <br>
 * p(u) = 1 - ((1^2-4) * (3^2-4) /2!)t^2
 * 
 * @author Matsuura Y.
 */
final class BesselP1Asymptotic implements RawCoefficientCalculableFunction {

    private static final ComplexContinuedFractionFunction H1_UPPER4 = h1_upper4();
    ...
    public BesselP1Asymptotic(DoubleFiniteClosedInterval interval) {
        super();
    ...
    public double value(double t) {
        ...
        ComplexNumber vc = H1_UPPER4.value(ComplexNumber.ofImaginary(t));
     ...
     * が乗算される.
     */
    private static ComplexContinuedFractionFunction h1_upper4() {
