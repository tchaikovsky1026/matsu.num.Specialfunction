 ...
 * J1(x) = (x/2)F(u) としたときの, F(u)の推定に関する. <br>
 * F(u) = 1/(0!1!) - 1/(1!2!)u + ...
 * </p>
 * 
 * <p>
 ...
 * f'(u) = -1/(1!2!) + 1/(2!3!) * u - 1/(3!4!) * u^2 <br>
 * その残差: <br>
 * F'(u) - f'(u) =
 * Sum_{m=3 to inf} (-1)^{m+1} u^m / ((m+1)!(m+2)!) <br>
 * を提供する. <br>
 * スケールは(1/u)である.
 * </p>
 * 
 * @author Matsuura Y.
 */
final class BesselJ1Power implements RawCoefficientCalculableFunction {
    ...
    public BesselJ1Power(DoubleFiniteClosedInterval interval) {
        super();
