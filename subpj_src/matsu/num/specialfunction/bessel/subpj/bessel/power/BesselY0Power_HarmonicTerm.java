 ...
 * g(u) = H_0 - H_1/(1!)^2 * u + H_2/(2!)^2 * u^2 - H_3/(3!)^2 * u^3 <br>
 * その残差: <br>
 * G(u) - g(u) =
 * Sum_{m=4 to inf} (-1)^m*H_m/(m!)^2 * u^m <br>
 * を提供する. <br>
 * スケールは1とする.
 * </p>
 * 
 * @author Matsuura Y.
 */
final class BesselY0Power_HarmonicTerm implements RawCoefficientCalculableFunction {
    ...
    public BesselY0Power_HarmonicTerm(DoubleFiniteClosedInterval interval) {
        super();
